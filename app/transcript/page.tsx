          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            >
              <div className="space-y-4">
                ...
                <label
                  htmlFor="file-upload"
                  className="inline-block px-6 py-2 rounded-lg bg-panel border border-border text-foreground hover:bg-panelHover cursor-pointer transition-colors"
                >
                  Choose File
                </label>
                {busy && <div className="text-sm text-[#b5b5b5]">Processing…</div>}
              </div>
            </div>
