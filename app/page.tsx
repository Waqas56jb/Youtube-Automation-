                  ...
                  <div key={v.id} className="rounded-lg overflow-hidden border border-white/10 bg-[#0b0c10]">
                    ...
                    <div className="p-3">
                      ...
                      <div className="mt-2 flex gap-2">
                        <button className="px-2 py-1 rounded border border-white/10 text-xs bg-black/20 hover:bg-black/30">Edit</button>
                        <button className="px-2 py-1 rounded border border-white/10 text-xs bg-black/20 hover:bg-black/30">Analytics</button>
                        <button className="px-2 py-1 rounded border border-white/10 text-xs bg-black/20 hover:bg-black/30">Delete</button>
                      </div>
                  </div>
                  </div>
                ))}
                  ...
                  <div key={s.id} className="flex gap-3 rounded-lg border border-white/10 bg-[#0b0c10] p-2">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="mt-1 flex gap-2">
                        <button className="px-2 py-1 rounded border border-white/10 text-[11px] bg-black/20 hover:bg-black/30">Reschedule</button>
                        <button className="px-2 py-1 rounded border border-white/10 text-[11px] bg-black/20 hover:bg-black/30">Edit</button>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div className="rounded-xl border border-white/10 bg-[#0f0f12] p-4">
              ...
              <div className="mt-3 flex gap-2">
                <button className="px-3 py-2 rounded-lg border border-white/10 bg-black/20 text-xs hover:bg-black/30">Save rule</button>
                <button className="px-3 py-2 rounded-lg border border-white/10 bg-black/20 text-xs hover:bg-black/30">Pause</button>
              </div>
            </div>
            <div className="rounded-xl border border-white/10 bg-[#0f0f12] p-4">
              ...
              <div className="mt-3 flex gap-2">
                <button className="px-3 py-2 rounded-lg border border-white/10 bg-black/20 text-xs hover:bg-black/30">Upload</button>
                <button className="px-3 py-2 rounded-lg border border-white/10 bg-black/20 text-xs hover:bg-black/30">Apply template</button>
              </div>
            </div>
            <div className="rounded-xl border border-white/10 bg-[#0f0f12] p-4">
            ...
            <div className="rounded-xl border border-white/10 bg-[#0f0f12] p-4">
              ...
              <div className="flex gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <div className="mt-2 flex gap-2">
                    <button className="px-2 py-1 rounded border border-white/10 text-[11px] bg-black/20 hover:bg-black/30">Open</button>
                    <button className="px-2 py-1 rounded border border-white/10 text-[11px] bg-black/20 hover:bg-black/30">Insights</button>
                  </div>
                </div>
              </div>
            </div>
